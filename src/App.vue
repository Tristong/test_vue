            ...
            <ul>
              <li>
                <router-link class="nav-item" to="/">
                  Home
                  <span class="nav-description">some description</span>
                </router-link>
              </li>
              <li>
                <router-link class="nav-item" to="/aboutUs">
                  About Us
                  <span class="nav-description">some description</span>
                </router-link>
              </li>
              <li>
                <router-link class="nav-item" to="/contactUs">
                  Contact Us
                  <span class="nav-description">some description</span>
                </router-link>
              </li>
...
<script >
import ResponsiveNav from './components/responsiveNav/ResponsiveNav.vue'
export default {
  name: 'app',
  components: {
